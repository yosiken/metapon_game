...
const MAX_STACKS := 3
const TICKS := 60
const OVERFLOW_GRACE_FRAMES := 90   # 1.5s

# --- 物理 (7.3) ---
const MATCH_MIN := 3
const FREEZE_DELAY_FRAMES := 7      # 0.12s
const FREEZE_IMPULSE := 12.0
const BASE_ACCEL := 8.0
const V_MAX_UP := 14.0
const V_MAX_DOWN := 18.0
const CHAIN_GRACE_FRAMES := 21      # 0.35s
...
# --- 拍 (4.6) ---
const BPM := 150                    # 900 / BPM が整数であること
...
## グリッド1目盛りのフレーム数。BPM150 なら 8分=12 / 16分=6（4.6.3）
